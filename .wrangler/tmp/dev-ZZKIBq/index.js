...
// .wrangler/tmp/bundle-TShqZ0/checked-fetch.js
...
var src_default = {
  async fetch(request, env, ctx) {
    try {
      console.log("\u{1F680} Worker request received:", {
        url: request.url,
        method: request.method,
        hasDB: !!env.DB,
        environment: "production"
        // Hardcode since process.env isn't available
      });
      if (!env.DB) {
...
async function handleDebugAPI(request, env) {
  try {
    const debugInfo = {
      ...
      discordClientId: "SET",
      // Hardcode since we can't access env vars
...
__name(handleNextAuth, "handleNextAuth");
...
// .wrangler/tmp/bundle-TShqZ0/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-TShqZ0/middleware-loader.entry.ts
