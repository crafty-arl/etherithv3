...
// Simulate D1 database structure
...
// Test the authentication flow with simulated D1
async function testD1Authentication() {
  ...
  // Simulate globalThis.DB binding (like in Cloudflare Workers)
  globalThis.DB = db;
