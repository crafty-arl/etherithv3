...
import { Eye, EyeOff, Lock, Mail, User, MessageCircle, Heart, CheckCircle } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden"
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          <div className="relative">
            ...
            {/* Username Input */}
            <div>
              <label htmlFor="username" className="block text-sm font-medium text-stone-700 mb-2 font-inter">
                Username
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  onFocus={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = '0 0 0 3px rgba(210, 180, 140, 0.2), inset 2px 2px 4px rgba(0,0,0,0.05)';
                  }}
                  onBlur={(e) => {
                    e.currentTarget.style.borderColor = '#d2b48c';
                    e.currentTarget.style.boxShadow = 'inset 2px 2px 4px rgba(0,0,0,0.05), 0 2px 8px rgba(210, 180, 140, 0.1)';
                  }}
        ...
        <div className="max-w-md w-full space-y-8 p-8 rounded-3xl border"
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="firstName" className="block text-sm font-medium text-stone-700 mb-2 font-inter">
                  First name
                </label>
                <div className="relative">
                  <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5"
              ...
              <div>
                <label htmlFor="lastName" className="block text-sm font-medium text-stone-700 mb-2 font-inter">
                  Last name
                </label>
                <div className="relative">
                  <User className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-stone-700 mb-2 font-inter">
                Confirm password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5"
